  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved expenditure as @expenditure" do
        ...
        post :create, {:expenditure => { "rec_type" => "invalid value" }}, valid_session
        assigns(:expenditure).should be_a_new(Expenditure)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested expenditure" do
        ...
        Expenditure.any_instance.should_receive(:update_attributes).with({ "rec_type" => "" })
        put :update, {:id => expenditure.to_param, :expenditure => { "rec_type" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the expenditure as @expenditure" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Expenditure.any_instance.stub(:save).and_return(false)
        put :update, {:id => expenditure.to_param, :expenditure => { "rec_type" => "invalid value" }}, valid_session
        assigns(:expenditure).should eq(expenditure)
      end
